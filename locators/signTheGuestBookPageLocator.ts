...
export default class SignTheGuestbookLocator {
    ...
    public get subscribeCheckBox() {
        ...
        } else throw new Error("Subscribe checkbox not found.")
    }
    ...
    public get maleRadialButton() {
        ...
        } else throw new Error("Male radial button not found.")
    }
    ...
    public get femaleRadialButton() {
        ...
        } else throw new Error("Female radial button not found.")
    }
    ...
    public get testToolDropDown() {
        ...
        } else throw new Error("Test Automation tool dropdown not found.")
    }
    ...
    public get playwrightOption() {
        ...
        } else throw new Error("Playwright option not found.")
    }
    ...
    public get commentTextArea() {
        ...
        } else throw new Error("Comment Text Area not found.")
    }
    ...
    public get countLabel() {
        ...
        if (countLabel !== null) {
            return countLabel
        } else throw new Error("Count label not found.")
    }
